...
func _ready():
	...
	$TestEuropeUserConsent.pressed = AdMobEditor.AdMobSettings.config.general.is_test_europe_user_consent
...
func _on_TestEuropeUserConsent_pressed():
	AdMobEditor.AdMobSettings.config.general.is_test_europe_user_consent = $TestEuropeUserConsent.pressed
