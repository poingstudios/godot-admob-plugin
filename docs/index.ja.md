...
=== "Android"
    ...
    2. **オプション** タブで：
       ...
       - **Min SDK** を `23`（Android 6.0）に設定します。
       - **Plugins** 内の **Ad Mob** を **オン** にします。
    3. **プロジェクトをエクスポート...** をクリックして APK または AAB ファイルを生成します。

    ![Android エクスポートプリセット](assets/export_android.png)
...
=== "iOS"
    ...
    2. **オプション** タブで：
       - **Plugins** 内の **Ad Mob** を **オン** にします。
    3. **プロジェクトをエクスポート...** をクリックして Xcode プロジェクトを生成します。
