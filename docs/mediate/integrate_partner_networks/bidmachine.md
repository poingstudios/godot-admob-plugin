...
=== "iOS"
    The BidMachine adapter is **already included** in the standard iOS plugin download. If you followed the [iOS Installation guide](../../index.md#download-install), you should already have the necessary files (`poing-godot-admob-bidmachine.gdip` and related frameworks) in your `res://ios/plugins/` directory.
