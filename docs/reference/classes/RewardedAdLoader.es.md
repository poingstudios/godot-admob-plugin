...
La clase `RewardedAdLoader` es responsable de ejecutar solicitudes de anuncios asíncronas para cargar instancias de [`RewardedAd`](RewardedAd.md).

## Métodos

### `load` / `Load`

Envía una solicitud de carga para un anuncio Recompensado.
