...
A classe `RewardedAd` representa um formato de anúncio recompensado em tela cheia onde os usuários podem optar por assistir a um anúncio em troca de recompensas no jogo/aplicativo.
...
Apresenta a sobreposição de anúncio recompensado em tela cheia.
