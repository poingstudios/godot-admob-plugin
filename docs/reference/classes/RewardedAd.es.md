...
La clase `RewardedAd` representa un formato de anuncio recompensado a pantalla completa donde los usuarios pueden optar por ver un anuncio a cambio de recompensas en el juego/aplicación.
...
Presenta la superposición de anuncio recompensado a pantalla completa.
