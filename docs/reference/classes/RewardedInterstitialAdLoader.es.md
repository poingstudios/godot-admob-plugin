...
La clase `RewardedInterstitialAdLoader` es responsable de ejecutar solicitudes de anuncios asíncronas para cargar instancias de [`RewardedInterstitialAd`](RewardedInterstitialAd.md).

## Métodos

### `load` / `Load`

Envía una solicitud de carga para un anuncio Intersticial Recompensado.
