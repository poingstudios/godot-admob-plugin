...
La clase `AppOpenAdLoader` es responsable de ejecutar solicitudes de anuncios asíncronas para cargar instancias de [`AppOpenAd`](AppOpenAd.md).

## Métodos

### `load` / `Load`

Envía una solicitud de carga para un anuncio App Open.
