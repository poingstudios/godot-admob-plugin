...
The `RewardedInterstitialAd` class represents a rewarded interstitial full-screen ad format that serves ads without requiring opt-in, but still rewards users who complete viewing.
...
Presents the full-screen Rewarded Interstitial ad overlay.
