...
- Utilice `tag_for_under_age_of_consent` with `RequestConfiguration.TagForUnderAgeOfConsent.UNSPECIFIED` para indicar que no ha especificado si la solicitud de anuncio debe recibir tratamiento para usuarios en el Espacio Económico Europeo (EEE) menores de edad de consentimiento.
...
Para garantizar el cumplimiento de las normas de la [Política de anuncios inapropiados](https://support.google.com/googleplay/android-developer/answer/9857753#zippy=%2Cexamples-of-common-violations) de Google Play, que abarca ofertas asociadas dentro de los anuncios, es esencial que todos los anuncios y sus ofertas asociadas que se muestran en su aplicación estén alineados con la [calificación de contenido](https://support.google.com/googleplay/android-developer/answer/9898843). Esto se aplica incluso si el contenido en sí cumple con las políticas de Google Play.
...
`AdRequest` recopila información de segmentación que se enviará con una solicitud de anuncio individual.

### Agregar extras de red
...
=== "GDScript"
    ...
    # Luego cargue el anuncio con la solicitud, ej.:
