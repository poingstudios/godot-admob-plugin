...
func _copy_virtual_file(src_path: String, dest_path: String) -> bool:
	...
	if f_src.open(src_path, File.READ) != OK:
		print("AdMob Error: Failed to open virtual src file: " + src_path)
		return false
		
	var f_dest = File.new()
	if f_dest.open(dest_path, File.WRITE) != OK:
		print("AdMob Error: Failed to open physical dest file: " + dest_path)
		f_src.close()
		return false
...
func _extract_android_zip(zip_path: String) -> void:
	if ProjectSettings.load_resource_pack(zip_path):
		var success = true
		success = success and _copy_virtual_file("res://AdMob.gdap", "res://android/plugins/AdMob.gdap")
		success = success and _copy_virtual_file("res://build/outputs/aar/admob-release.aar", "res://android/plugins/admob-release.aar")
		success = success and _copy_virtual_file("res://build/outputs/aar/admob-debug.aar", "res://android/plugins/admob-debug.aar")
		...
		print("AdMob Error: Failed to load Android resource pack: " + zip_path)

func _extract_ios_zip(zip_path: String) -> void:
	if ProjectSettings.load_resource_pack(zip_path):
		var success = true
		success = success and _copy_virtual_file("res://admob.gdip", "res://ios/plugins/admob.gdip")
		success = success and _copy_virtual_file("res://admob/bin/admob.release.a", "res://ios/plugins/admob/bin/admob.release.a")
		success = success and _copy_virtual_file("res://admob/bin/admob.debug.a", "res://ios/plugins/admob/bin/admob.debug.a")
		...
		print("AdMob Error: Failed to load iOS resource pack: " + zip_path)
